...
> Historical checkpoint. Phase 7 has since been completed; use [PHASE-7-GUIDE.md](PHASE-7-GUIDE.md) and the current handoff. The pause instructions and source below describe the earlier first-half snapshot.
