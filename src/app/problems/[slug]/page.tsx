  ...
  return <AppShell signedIn={view.signedIn} admin={view.admin}>
    ...
    <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1.7fr)_minmax(18rem,1fr)]">
      <div className="min-w-0 space-y-6">
        ...
        <Card id="editor"><CardTitle>Code editor</CardTitle><CodeEditor key={problem.slug} starters={problem.starterCode} examples={problem.examples} slug={problem.slug} signedIn={view.signedIn} runnerEnabled={Boolean(getRunnerConfig()) && runnerSupports(problem.slug)} signature={runnerSupports(problem.slug) ? SIGNATURES[problem.slug] : undefined} /></Card>
